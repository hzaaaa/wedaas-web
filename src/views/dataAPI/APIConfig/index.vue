<template>
	<div class="api-config">
		...
		<el-radio-group
			v-show="activeName === 2"
			v-model="paramsConfigRadio"
			@change="onceShow[paramsConfigRadio] = true"
...
// const paramsConfig = defineAsyncComponent(() => import("./components/paramsConfig/index.vue"));
// const paramsCode = defineAsyncComponent(() => import("./components/paramsCode/index.vue"));
const activeName = ref(2);
const paramsConfigRadio = ref("config");
const onceShow = ref({
	config: paramsConfigRadio.value === "config",
	code: paramsConfigRadio.value === "code",
});
const preStep = () => {
	activeName.value--;
};
