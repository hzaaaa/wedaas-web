<template>
	<div class="advanced-search-wrapper" :style="{ width: isCollapse ? '24px' : '224px' }">
		<div class="action-btn-wrap" :style="{ justifyContent: isCollapse ? 'center' : '' }">
		...
		<Transition>
			<div class="search-form-wrapper" v-if="!isCollapse" style="margin-top: 20px">
